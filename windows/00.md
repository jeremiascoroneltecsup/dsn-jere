...
```bash
# Eliminar registro de una distribución Ubuntu existente en WSL (Windows)
wsl --unregister Ubuntu

# Actualizar los repositorios y paquetes del sistema (Ubuntu)
...
killall php   # Detiene cualquier proceso PHP en ejecución
...
- Para detener el contenedor: `docker stop laravel`
- Para iniciar el contenedor: `docker start laravel`
- Para eliminar el contenedor: `docker rm laravel`
